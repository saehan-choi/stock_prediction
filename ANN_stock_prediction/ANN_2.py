...
train_path = f"./input/train2.csv"
val_path = f"./input/validation2.csv"
test_path = f"./input/test2.csv"
...
for epochs in range(num_epochs):
    ...
    print(f'batch_size:{batch_size} learning_rate{1e-4}')



PATH = './weights/'
torch.save(net.state_dict(), PATH+f'batch{batch_size}_lr{1e-4}_model_test.pt')
